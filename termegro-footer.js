    ...
    return `
      <div class="termegro-logo">
        <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- T Letter -->
          <rect x="45" y="25" width="30" height="6" fill="white" class="logo-element"/>
          <rect x="57" y="25" width="6" height="40" fill="white" class="logo-element"/>
          
          <!-- D Letter -->
          <path d="M75 35 L75 55 L85 55 C90 55 95 50 95 45 C95 40 90 35 85 35 Z" 
                fill="white" class="logo-element"/>
          
          <!-- Decorative Elements -->
          <circle cx="35" cy="45" r="3" fill="white" opacity="0.8" class="logo-accent"/>
          <circle cx="40" cy="55" r="2" fill="white" opacity="0.6" class="logo-accent"/>
          <circle cx="30" cy="55" r="2" fill="white" opacity="0.6" class="logo-accent"/>
        </svg>
      </div>
    `;
  }
